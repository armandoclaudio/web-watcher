<x-layouts.app>
    <div class="mb-6">
        ...
        <h1 class="text-xl font-semibold mt-2">Edit Alert</h1>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 max-w-lg">
        <form method="POST" action="{{ route('alerts.update', $alert) }}">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('alerts.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Cancel</a>
            </div>
        </form>
    </div>
</x-layouts.app>
